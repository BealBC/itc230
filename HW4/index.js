...
app.post('/add', function(req, res){
    var totalBike = {brand : req.body.brand, model : req.body.model, size : req.body.size}; 
    var added = bikes.add(totalBike); 
    res.render('add',{brand: req.body.brand, result: added});
}); 
